  ...
  <body>
    ...
    <?php
      if (isset($_POST['field_submit'])) {
        ...
        <?php } else { ?>
          Sorry, no restaurants found for <?php echo $_POST['field_restau_name']; ?> in <?php echo $_POST['field_in_city']; ?> (city). Make sure that the first letter you used in the city name is uppercase.
        <?php }
    } ?>
