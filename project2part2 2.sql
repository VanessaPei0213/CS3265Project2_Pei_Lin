...
BEGIN
    ...
    loop_label: LOOP
		...
		IF i = index_number THEN
			LEAVE loop_label;
		END IF;
    
		INSERT INTO awards_table
		SELECT restaurant_link, SUBSTRING_INDEX(SUBSTRING_INDEX(awards,',', -i),',', 1)
		FROM mega_table
...
BEGIN
    ...
    loop_label: LOOP
		...
		INSERT INTO res_features
		SELECT restaurant_link, SUBSTRING_INDEX(SUBSTRING_INDEX(features,',', -i),',', 1)
		FROM mega_table
